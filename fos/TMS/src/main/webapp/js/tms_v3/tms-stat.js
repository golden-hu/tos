...
var getStatPanel = function(){
	...
	var statPanel = new Ext.Panel({title:'业务统计',collapsible:true,layout:'fit',iconCls:'folder_go',
        	      ...
        	      new Ext.PagingToolbar({pageSize:C_PS100,store:store,displayInfo:true,displayMsg:'{0} - {1} of {2}',emptyMsg:C_NR,
	      	        	doLoad : function(start){
	      	                ...
	      	                if(this.fireEvent('beforechange', this, o) !== false){
	      	                    this.store.load({params:o,callback:function(){reCalculate();}});
	      	                }
	      	            }
      	        	})
        	      ]
