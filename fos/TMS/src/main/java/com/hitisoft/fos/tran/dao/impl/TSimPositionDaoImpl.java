...
@Repository
public class TSimPositionDaoImpl extends JpaDao<TSimPosition, Long> implements TSimPositionDao {
	@Autowired
	private RequestContext requestContext;
	@Autowired
	private SessionContext sessionContext;
	
	public TSimPositionDaoImpl() {
		super(TSimPosition.class);
	}
	...
	public List <Object> getCurruntPosition(List<HtQuery> conditions){
		...
		final Class t1 = TSimPosition.class;
