...
Fos.WCargoDetailPanel=function(p,store){
	...
	var numPQuantity=new Ext.form.NumberField({fieldLabel:'单品比率',name:'pQuantity',value:p.get('pQuantity'),anchor:'95%'});
	...
	var ccboInUnitName=new Ext.form.ComboBox({fieldLabel:'默认入库包装',name:'inUnitValue',store:WHTStore.IN_UNIT_NAME,
		value:p.get('inUnitValue'),displayField:'NAME',valueField:'CODE',typeAhead: true,mode:'local',itemCls:'required',
		triggerAction: 'all',selectOnFocus:true,anchor:'95%',
		listeners:{}});
