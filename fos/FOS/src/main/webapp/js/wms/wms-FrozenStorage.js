Fos.FrozenStoragePanel = function(a){
	...
	{header:'类型',dataIndex:'frozenCategory',width:120,align:'center'},
	...
	var sheet1= new Ext.Panel({scope:this,padding:5,height:150,
		...
		items:[{columnWidth:0.25,layout:'form',border:false,items:[lkpCargoOwnerName,ccboBlockName,txtstorageNoteNo,datreceivedDate]},
		       {columnWidth:0.25,layout:'form',border:false,items:[ccboCargoName,ccboAreaName,txtEntrustNo,datendReceivedDate]},
		       {columnWidth:0.25,layout:'form',border:false,items:[txtcategoryName,ccboWarehouseName,ctxtProductNo]},
		       a.get('statusFrozen')==0?{columnWidth:0.25,layout:'form',border:false,items:[cobxactionGategory,checkoverDue]}:
		       {columnWidth:0.25,layout:'form',border:false,items:[cobxactionGategory,cobxHHold,checkoverDue]},
		]
	});
