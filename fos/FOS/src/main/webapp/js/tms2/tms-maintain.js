...
Fos.AccidentGrid = function() {
	...
	{header:C_ACCIDENT_DATE,dataIndex:'accidentDate',align:'center',renderer:formatDate,width:100},
	{header:C_ACCIDENT_TYPE,dataIndex:'accidentTypeName',align:'center',width:100},
	{header:C_VEHICLE_NO,dataIndex:'vehicleNo',align:'center',width:100},
	{header:C_DRIVER,dataIndex:'driverName',align:'center',width:100},
	{header:C_ACCIDENT_PLACE,dataIndex:'place',align:'center',width:100},
	{header:C_LOSS_AMOUNT,dataIndex:'lossAmount',align:'center',width:100},
	{header:C_COMPENSATE_AMOUNT,dataIndex:'compensateAmount',align:'center',width:100},
	{header:C_INJURY_NUM,dataIndex:'injuryNum',align:'center',width:100},
	{header:C_DEATH_NUM,dataIndex:'deathNum',align:'center',width:100}
...
Fos.OilLogGrid = function(){
	...
	var cm=new Ext.grid.ColumnModel({columns:[
	 new Ext.grid.RowNumberer(),sm,
	{header:C_REFUEL_DATE,dataIndex:'refuelDate',align:'center',renderer:formatDate,width:100},
	{header:C_VEHICLE_NO,dataIndex:'vehicleNo',align:'center',width:100},
	{header:C_DRIVER,dataIndex:'driverName',align:'center',width:100},
	{header:C_OIL_STATION,dataIndex:'oilStationName',align:'center',width:100},
	{header:C_OIL_TYPE,dataIndex:'oilTypeName',align:'center',width:100},
	{header:C_OIL_NUM,dataIndex:'num',align:'center',width:100},
	{header:C_OIL_PRICE,dataIndex:'price',align:'center',width:100},
	{header:C_OIL_AMOUNT,dataIndex:'amount',align:'center',width:100}
	],defaults:{sortable:false,width:100}});
...
Fos.RepairLogGrid = function() {
	...
	var cm=new Ext.grid.ColumnModel({columns:[
	 new Ext.grid.RowNumberer(),sm,
	{header:C_REPAIR_NO,dataIndex:'repairNo',align:'center',width:100},
	{header:C_REPAIR_DATE,dataIndex:'repairDate',align:'center',renderer:formatDate,width:100},
	{header:C_VEHICLE_NO,dataIndex:'vehicleNo',align:'center',width:100},
	{header:C_DRIVER,dataIndex:'driverName',align:'center',width:100},
	{header:C_INVOICE_NO,dataIndex:'invoiceNo',align:'center',width:100},
	{header:C_INVOICE_AMOUNT,dataIndex:'invoiceAmount',align:'center',width:100},
	{header:C_ISPOINT_REPAIR,dataIndex:'isPoint',align:'center',width:100}
	],defaults:{sortable:false,width:100}});
...
Fos.RepairLogWin = function(p,listStore) {
	...
	var frm = new Ext.form.FormPanel({region:'north',height:150,layout:'column',layoutConfig:{columns:4},
		labelWidth:80,labelAlign:'right',padding:10,items:[
	...
	var cm=new Ext.grid.ColumnModel({columns:[sm,
  		{header:C_REPAIR_ITEM,dataIndex:'itemName',align:'center',width:100,editor:new Ext.form.TextField({})},
  		{header:C_PARTS_NUM,dataIndex:'partsNum',align:'center',width:100,editor:new Ext.form.NumberField({allowBlank:false})},
  		{header:C_PARTS_PRICE,dataIndex:'partsPrice',align:'center',width:100,
  			editor:new Ext.form.NumberField({decimalPrecision:4,allowBlank:false})},
  		{header:C_PARTS_FEE,dataIndex:'partsFee',align:'center',width:100,renderer:rateRender},
  		{header:C_HOURS,dataIndex:'hours',align:'center',width:100,editor:new Ext.form.NumberField({allowBlank:false})},
  		{header:C_HOURS_PRICE,dataIndex:'hoursPrice',align:'center',width:100,
  			editor:new Ext.form.NumberField({decimalPrecision:4,allowBlank:false})},
  		{header:C_HOURS_FEE,dataIndex:'hoursFee',align:'center',width:100,renderer:rateRender},
  		{header:C_TOTAL_AMOUNT,dataIndex:'totalAmount',align:'center',width:100,renderer:rateRender},
  		{header:C_REMARKS,dataIndex:'trcaRemarks',align:'center',width:100,editor:new Ext.form.TextField()}
  		],defaults:{sortable:false,width:100}});
	...
	Fos.RepairLogWin.superclass.constructor.call(this,{buttonAlign:'right',
		...
		width:900,height:500,layout:'border',modal:true,
	  	items:[frm,grid],
...
Fos.TransTaskPosition = function(vehicleNo) {
	...
	var frm = new Ext.form.FormPanel({region:'north',height:150,layout:'column',layoutConfig:{columns:4},
		...
		{columnWidth:.25,layout:'form',border:false,items:[
            ...
            {fieldLabel:C_SUM_CBM,name:'volume',
	...
	{header:C_SIZE,dataIndex:'volume',width:60,renderer:rateRender},
