...
Fos.VehicleGrid = function() {
	...
	{header:C_VEHICLE_NAME,dataIndex:'vehicleName',width:100},
	{header:C_MOTORCADE,dataIndex:'motorcadeName',width:150},
	{header:C_VEHICLE_CLASS,dataIndex:'vehicleClassName',width:100},
	{header:C_MAX_LOAD,dataIndex:'maxLoad',width:100},
	{header:C_INSPECT_DATE_FROM,dataIndex:'inspectDateFrom',renderer:formatDate,width:150},
	{header:C_INSPECT_DATE_TO,dataIndex:'inspectDateTo',renderer:formatDate,width:150},
	{header:C_STATUS,dataIndex:'status',renderer:HTStore.vehicleStatusRender,width:100}
...
Fos.VehicleClassGrid = function() {
    ...
    var cm=new Ext.grid.ColumnModel({columns:[
     new Ext.grid.RowNumberer(),sm,
	{header:C_VEHICLE_CLASS_NAME,dataIndex:'vehicleClassName',editor:new Ext.form.TextField()}
...
Fos.AccidentTypeGrid = function() {
	...
	{header:C_ACCIDENT_TYPE_NAME,dataIndex:'accidentTypeName',editor:new Ext.form.TextField()}
    ],defaults:{sortable:false,width:150}});
...
Fos.OilTypeGrid = function() {
	...
	var sm=new Ext.grid.CheckboxSelectionModel({singleSelect:false});
    var cm=new Ext.grid.ColumnModel({columns:[new Ext.grid.RowNumberer(),sm,
	{header:C_OIL_TYPE_NAME,dataIndex:'oilTypeName',editor:new Ext.form.TextField()}
    ],defaults:{sortable:false,width:150}});
...
Fos.OilStationGrid = function() {
	...
	var sm=new Ext.grid.CheckboxSelectionModel({singleSelect:false});
    var cm=new Ext.grid.ColumnModel({columns:[new Ext.grid.RowNumberer(),sm,
	{header:C_OIL_STATION_NAME,dataIndex:'oilStationName',editor:new Ext.form.TextField()},isPoint
    ],defaults:{sortable:false,width:150}});
...
Fos.DriverGrid = function() {
	...
	var cm=new Ext.grid.ColumnModel({columns:[
	     new Ext.grid.RowNumberer(),sm,
      	{header:C_DRIVER_CODE,dataIndex:'driverCode',width:100},
      	{header:C_DRIVER_NAME,dataIndex:'driverName',width:100},
      	{header:C_MOTORCADE,dataIndex:'motorcadeName',width:120},
      	{header:C_MOBILE,dataIndex:'mobile',width:80},
      	{header:C_TEL,dataIndex:'homeTel',width:80},
      	{header:C_LICENSE_NO,dataIndex:'licenseNo',width:100},
      	{header:C_DEPOSIT,dateIndex:'deposit',width:80},
      	{header:C_LICENSE_DATE,dataIndex:'licenseDate',renderer:formatDate,width:100},
      	{header:C_EFFECTIVE_DATE_FROM,dataIndex:'effectiveDateFrom',renderer:formatDate,width:100},
      	{header:C_EFFECTIVE_DATE_TO,dataIndex:'effectiveDateTo',renderer:formatDate,width:100},
      	{header:C_INSPECT_DATE_FROM,dataIndex:'inspectDateFrom',renderer:formatDate,width:100},
      	{header:C_INSPECT_DATE_TO,dataIndex:'inspectDateTo',renderer:formatDate,width:100},
      	{header:C_JOIN_DATE,dataIndex:'joinDate',renderer:formatDate,width:100},
      	{header:C_LEAVE_DATE,dataIndex:'leaveDate',renderer:formatDate,width:100}
      	],defaults:{sortable:false,width:100}});
...
Fos.TransTypeGrid = function() {
	...
	var sm=new Ext.grid.CheckboxSelectionModel({singleSelect:false});
    var cm=new Ext.grid.ColumnModel({columns:[new Ext.grid.RowNumberer(),sm,
	{header:C_TRAT,dataIndex:'transTypeName',editor:new Ext.form.TextField()}
    ],defaults:{sortable:false,width:150}});
...
Fos.OilCardPanel = function() {
    ...
    var cm=new Ext.grid.ColumnModel({columns:[new Ext.grid.RowNumberer(),sm,
	{header:'卡号',dataIndex:'cardNumber',editor:new Ext.form.TextField()},
	{header:'名称',dataIndex:'cardType',editor:new Ext.form.TextField()},
	...
	{header:'日期',dataIndex:'transactionDate',renderer:formatDate},
	{header:'交易类型',dataIndex:'transactionType',renderer:function(v){if(v==0) return '充值';else return '消费';}},
	{header:'金额',dataIndex:'amount'},
	{header:'车辆',dataIndex:'vehicleNo'},	
...
Fos.PEventTypeTab = function() {
	...
	var m = M1_TMS + TMS_TRACING_SETTING;
    var btnAdd = new Ext.Button({text:C_ADD,iconCls:'add',disabled:NR(m+F_M),
    	scope:this,handler:this.add});
    var btnRemove = new Ext.Button({text:C_REMOVE,iconCls:'remove',disabled:NR(m+F_R),
    	scope:this,handler:this.del});
	...
	Fos.PEventTypeTab.superclass.constructor.call(this,{id:'P_EVENTTYPE',title:C_TRACING_SETTING,closable:true,	
...
Fos.GSiteGrid = function() {
	...
	var cm=new Ext.grid.ColumnModel({columns:[new Ext.grid.RowNumberer(),sm,
          ...
          {header:C_CONTACT,dataIndex:'siteContact',editor:new Ext.form.TextField()},
          {header:C_TEL,dataIndex:'siteTel',editor:new Ext.form.TextField(),width:150},
          {header:C_FAX,dataIndex:'siteFax',editor:new Ext.form.TextField(),width:150},
          {header:C_ADDRESS,dataIndex:'siteAddress',editor:new Ext.form.TextField(),width:200},
          {header:C_SITE_TYPE,dataIndex:'siteType',renderer:HTStore.getSITE_TYPE,
          ...
          {header:C_PROVINCE,dataIndex:'provinceName',
  			...
  			{header:C_CITY,dataIndex:'cityName',
