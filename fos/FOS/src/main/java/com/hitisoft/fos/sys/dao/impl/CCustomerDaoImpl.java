...
@Repository
public class CCustomerDaoImpl extends JpaDao<CCustomer, Long> implements CCustomerDao {
	private Logger logger = LoggerFactory.getLogger(CCustomerDaoImpl.class);

	public CCustomerDaoImpl() {
