...
public class MappingConverterUtil {
	...
	public String toLocalDate(String strDate) {
		...
		try {
			...
			logger.error("convert date ({}) from {} to {} failed!",
					new Object[] { strDate, from, to });
		}
		return targetDate;
	}
	...
	public String getPlacedStatus(String code) {
		String status = "";
		if ("0".equals(code)) {
			status = "新增";
		} else if ("1".equals(code)) {
	...
	public String getContainerInfo(String s) {
		String n = "海运";
		if (StringUtil.isBlank(s)) {
			return n;
		} else {
	...
	public String tcStatus(String code) {
		String status = "";
		if ("0".equals(code)) {
			status = "新增";
		} else if ("1".equals(code)) {
	...
	public String tcDemageStatus(String code){
		String status = "";
		if ("0".equals(code)) {
			status = " ";
		} else if ("1".equals(code)) {
