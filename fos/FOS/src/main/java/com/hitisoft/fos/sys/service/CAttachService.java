...
public class CAttachService {
	...
	public void downAttach() {
		...
		if (StringUtil.isNotBlank(attachId)) {
			...
			String filename =configUtil.getAttachDir() + ConstUtil.DIR_SEP +attachId +  ConstUtil.STRING_DOT + extName;
